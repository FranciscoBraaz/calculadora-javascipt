...
Esse projeto é uma modesta extensão da atividade prática desenvolvida no curso de JavaScript da Hcode. Algumas pequenas alterações foram feitas para colocar os conhecimentos adquiridos em p´rática, por exemplo:
